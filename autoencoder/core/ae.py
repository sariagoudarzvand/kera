    ...
    def fit(self, train_X, val_X, nb_epoch=50, batch_size=100, contractive=None):
        ...
        self.autoencoder.fit(train_X[0], train_X[1],
                        ...
                        callbacks=[
                                    ...
                                    EarlyStopping(monitor='val_loss', min_delta=1e-5, patience=20, verbose=1, mode='auto'),
                                    CustomModelCheckpoint(self.encoder, self.save_model, monitor='val_loss', mode='auto')
                                    # ModelCheckpoint(filepath="./checkpoint/{epoch}.hdf5")
                        ]
                        )
