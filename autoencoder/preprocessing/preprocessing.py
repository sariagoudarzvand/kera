...
def init_stopwords():
    ...
    cached_stop_words.update(('either', 'completely', 'easy', 'reality', 'without', 'primary', 'easily',
                                'upon', 'other', 'someone', 'two', 'okay', 'everybody',
                                'never', 'whose', 'one', 'today', 'something', 'lciii', 'lines', 'date',
                                'references', 'sender', 'message-id', 'from', 'path', 'newsgroups', 'from', 'also',
                                'subject', 'basically', 'anywhere', 'particularly', 'yes', 'essentially', 'recently',
                                'less', 'entirely', 'unfortunatelly', 'anyone', 'somehow', 'correctly', 'nobody',
                                'highly', 'extra', 'another', 'behind', 'really', 'things', 'merely', 'whatever', 'hey',
                                'properly', 'anyway', 'truly', 'actual', 'whatever', 'already', 'actually', 'rather',
                                'could', 'usually', 'mostly', 'would', 'much', 'sorry', 'anyway', 'great', 'often',
                                'important', 'willing', 'still', 'immediately', 'fully', 'whole', 'along', 'obviously',
                                'hello', 'neither', 'sometimes', 'toward', 'certainly', 'sunday', 'quite', 'ago',
                                'somewhere', 'unless', 'surely', 'absolutely', 'however', 'therefore', 'though',
                                'although', 'among', 'due', 'currently', 'thank', 'everything', 'everyone',
                                'anything', 'within', 'yesterday', 'soon', 'must', 'please', 'etc', 'usual', 'maybe',
                                'non', 'totally', 'truly', 'beyond', 'necessarily', 'somebody', 'since', 'always',
                                'somewhat', 'if', 'else', 'anybody', 'slightly', 'directly', 'generally', 'eventually',
                                'exactly', 'fully', 'simply', 'many'))
...
def load_data(corpus_path, recursive=True, stem=True, stop_words=True):
...
def construct_corpus(corpus_path, training_phase, vocab_dict=None, threshold=5, topn=None, recursive=True):
